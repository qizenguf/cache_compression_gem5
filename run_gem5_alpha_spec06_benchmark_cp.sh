...
$GEM5_DIR/build/ALPHA/gem5.fast $GEM5_DIR/configs/example/spec06_config_single.py --benchmark=$BENCHMARK --take-checkpoint=379200000000 --at-instruction | tee -a $SCRIPT_OUT
