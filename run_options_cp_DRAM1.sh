...
GEM5_DIR=/home/qizeng/gem5_compress                          # Install location of gem5
...
$GEM5_DIR/build/ALPHA/gem5.opt --outdir=$OUTPUT_DIR/$BENCHMARK/cp$WARM_LEN'_options_'$5'L'$RUN_LEN $GEM5_DIR/configs/example/spec06_config_single.py --benchmark=$BENCHMARK --restore-with-cpu=detailed -s 1000000000 --cpu-clock=3GHz --mem-size=4GB --mem-channels=2 --mem-type=A1DDR4_2400_4x16 --caches --l1i_size=32kB --l1i_assoc=4 --l1d_size=32kB --l1d_assoc=4 --l2cache --l2_size=256kB --l2_assoc=8 --l3cache --l3_size=1MB --l3_assoc=8 --l3_tags=$5 --checkpoint-dir=/home/qizeng/cpu2006/benchspec/CPU2006/$BENCHMARK_CODE/run/run_base_ref_my-alpha.0000/m5out/ --checkpoint-restore=$WARM_LEN --maxinsts=$RUN_LEN --warmup-insts=1000000000
#$GEM5_DIR/build/ALPHA/gem5.opt --debug-flag=Cache,CacheRepl --outdir=$OUTPUT_DIR/$BENCHMARK/cp$WARM_LEN'_options_'$5 $GEM5_DIR/configs/example/spec06_config_single.py --benchmark=$BENCHMARK --restore-with-cpu=detailed -s 1000000000 --cpu-clock=3GHz --mem-size=4GB --mem-channels=2 --mem-type=DDR3_1600_8x8 --caches --l1i_size=32kB --l1i_assoc=4 --l1d_size=32kB --l1d_assoc=4 --l2cache --l2_size=256kB --l2_assoc=8 --l3cache --l3_size=1MB --l3_assoc=8 --l3_tags=$5 --checkpoint-dir=/home/qizeng/cpu2006/benchspec/CPU2006/$BENCHMARK_CODE/run/run_base_ref_my-alpha.0000/m5out/ --checkpoint-restore=$WARM_LEN --maxinsts=$RUN_LEN --warmup-insts=1000000000
