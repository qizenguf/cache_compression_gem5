...
$GEM5_DIR/build/ALPHA/gem5.opt --outdir=$OUTPUT_DIR/$BENCHMARK/car2b $GEM5_DIR/configs/example/spec06_config_single.py --benchmark=$BENCHMARK --cpu-type=TimingSimpleCPU --cpu-clock=3.2GHz --mem-size=4GB --mem-channels=2 --mem-type=DDR3_1600_8x8 --caches --l1i_size=32kB --l1i_assoc=8 --l1d_size=32kB --l1d_assoc=8 --l2cache --l2_size=256kB --l2_assoc=8 --l3cache --l3_size=4MB --l3_assoc=32 --l3_tags=1 --fast-forward=$WARM_LEN --maxinsts=$RUN_LEN
