...
$GEM5_DIR/build/ALPHA/gem5.opt $GEM5_DIR/configs/example/spec06_config_single.py --cpu-type=atomic   --benchmark=$BENCHMARK --at-instruction --checkpoint-at-end --maxinsts=$WARM_LEN | tee -a $SCRIPT_OUT 
