...
default=100000000
OUTPUT_DIR=0                  # Directory to place run output. Make sure this exists!
WARM_LEN=$(($2 * $default))
######################### BENCHMARK CODENAMES ####################
...
SCRIPT_OUT=$RUN_DIR/m5out/runscript.log                                                                   # File log for this script's stdout henceforth
...
#$GEM5_DIR/build/ALPHA/gem5.opt $GEM5_DIR/configs/example/spec06_config_single.py --benchmark=$BENCHMARK --take-checkpoint=$WARM_LEN --at-instruction | tee -a $SCRIPT_OUT 
/home/qizeng/gem5/build/ALPHA/gem5.opt ~/gem5/configs/example/spec06_config_single.py --benchmark=$BENCHMARK --cpu-type=atomic --num-cpus=4 --cpu-clock=3.2GHz --caches --l2cache --l1d_size=32kB --l1i_size=32kB --l2_size=1MB --l1d_assoc=4 --l1i_assoc=4 --l2_assoc=8 --l3cache --l3_size=16MB --l3_assoc=32 --l3_tags=2 --cacheline_size=64 --mem-type=DDR3_1600_8x8 --mem-channels=2 --mem-size=2GB --at-instruction --checkpoint-dir=/home/qizeng/gem5/cpts --checkpoint-at-end --maxinsts=$WARM_LEN