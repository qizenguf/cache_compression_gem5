...
SPEC_DIR=/home/group/spec                 # Install location of your SPEC2006 benchmarks
##################################################################
...
$GEM5_DIR/build/ALPHA/gem5.opt --outdir=$OUTPUT_DIR/$BENCHMARK/car2b /home/group/Documents/gem5/configs/example/spec06_config_single.py --benchmark=$BENCHMARK --cpu-type=detailed --cpu-clock=2GHz --mem-size=4GB --mem-channels=2 --mem-type=LPDDR3_1600_x32 --caches --l1i_size=32kB --l1i_assoc=8 --l1d_size=32kB --l1d_assoc=8 --l2cache --l2_size=256kB --l2_assoc=8 --l3cache --l3_size=8MB --l3_assoc=32 --l3_tags=1 --fast-forward=$3 --maxinsts=200000000
