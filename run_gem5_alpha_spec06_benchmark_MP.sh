...
OUTPUT_DIR=$1                  # Directory to place run output. Make sure this exists!
...
$GEM5_DIR/build/ALPHA/gem5.opt --outdir=$OUTPUT_DIR $GEM5_DIR/configs/example/spec06_config.py -n 4 --bench=bzip2-gcc-bizp2-gcc --maxinsts=200000000 --benchmark_stdout=$OUTPUT_DIR/$BENCHMARK.out --benchmark_stderr=$OUTPUT_DIR/$BENCHMARK.err --caches --l1i_size=32kB --l1d_size=32kB --l2cache --l2_size=4MB --l2_assoc=32 --fast-forward=2000000000 | tee -a $SCRIPT_OUT
